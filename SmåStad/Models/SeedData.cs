  ...
  public class SeedData {
    public static void EnsurePopulated(IServiceProvider services) {
      ...
      if (!context.Errands.Any()) {
        ...
        new Errand {
          RefNumber = "2018-45-195",
          Place = "Skogslunden vid Jensens gård",
          TypeOfCrime = "Sopor",
          DateOfObservation = new DateTime(2018, 04, 24),
        ...
        new Errand {
          RefNumber = "2018-45-196",
          Place = "Småstadsjön",
          TypeOfCrime = "Oljeutsläpp",
          DateOfObservation = new DateTime(2018, 04, 29),
        ...
        new Errand {
          RefNumber = "2018-45-197",
          Place = "Ödehuset",
          TypeOfCrime = "Skrot",
          DateOfObservation = new DateTime(2018, 05, 02),
          Observation = "Anmälaren körde förbi ödehuset och upptäcker ett antal bilar och annat skrot",
          InvestigatorInfo = "Undersökning har gjorts ochbilder har tagits",
          InvestigatorAction = "",
          InformerName = "OllePettersson",
        ...
        new Errand {
          RefNumber = "2018-45-198",
          Place = "Restaurang Krögaren",
          TypeOfCrime = "Buller",
          DateOfObservation = new DateTime(2018, 06, 04),
          Observation = "Restaurangen hade för högt ljud på så man inte kunde sova",
          InvestigatorInfo = "Bullermätning har gjorts.Man håller siginom riktvärden",
        ...
        new Errand {
          RefNumber = "2018-45-199",
          Place = "Torget",
          TypeOfCrime = "Klotter",
          DateOfObservation = new DateTime(2018, 07, 10),
